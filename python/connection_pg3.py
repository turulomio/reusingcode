...
class Connection:
    ...
    def connect(self, connection_string=None):
        if connection_string==None:
            ...
            s=connection_string
        try:
            self._con=psycopg_connect(s, row_factory=dict_row, cursor_factory=ClientCursor)
...
if __name__ == "__main__":
    ...
    if con.is_active():
        ...
        con.unogenerator_sheet("connection_pg3.ods",  sql, columns_widths=(10,10,4,4))
        print("File connection_pg3.ods has been generated")
